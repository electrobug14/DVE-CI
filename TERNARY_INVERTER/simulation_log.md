# 📊 EDA Report: `TERNARY_INVERTER`

> **Generated:** 2026-04-01 07:27:34 UTC
...
================================================
  [0 ns] trit_in=00 (0) | trit_out=10 (2)
  [10000 ns] trit_in=01 (1) | trit_out=01 (1)
  [20000 ns] trit_in=10 (2) | trit_out=00 (0)
  [30000 ns] trit_in=11 (3) | trit_out=00 (0)
================================================
...
|--------|-------|
| Total Cells | **2** |
| Estimated Transistors | **10** |
| Estimated Die Area | **0.1 µm²** |
...
── Critical Path ───────────────────────────────
  ...
  Combinational delay   : 0.09 ns
  Setup time            : 0.03 ns
  ─────────────────────────────────────────────
  Critical path total   : 0.22 ns
  Max frequency (est.)  : 4545.45 MHz
